...
import Logo1 from '../Image/Quickcashlogo13.svg';
    ...
    return (
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           ...
           <div className="logo img-fluid"><Link to =''><img src={Logo} className="img-fluid logo-height"></img></Link></div>
            :
            <div className="logo img-fluid"><Link to =''><img src={Logo1} className="img-fluid logo-height"></img></Link></div>
           } */}
           <div className="logo img-fluid"><Link to ='/'><img src={Logo1} className="img-fluid logo-height"></img></Link></div>
            <ul className="navLinks" ref= {navLinks}>
                <NavLink to="/landingpage" exact  activeClassName='activlink' ><li>Home</li></NavLink>
                {/* {(nav)?
                <NavLink to="/sellnow" activeClassName='activlink'  className="fir"><li>Sell Now / Buy Back</li></NavLink>
                :
                <NavLink to="/sellnow" activeClassName='activlink' className="sec"><li>Sell Now / Buy Back</li></NavLink>
                } */}
                <NavLink to="/landingpage"activeClassName='activlink' ><li>Quick Sell / Quick BuyBack</li></NavLink>
                <NavLink to="/landingpage" activeClassName='activlink' ><li>Quick Shop</li></NavLink>               
                <NavLink to="/landingpage" activeClassName='activlink'><li>Auction</li></NavLink>  
            </ul>
