...
import Logo from '../Image/Quickcashlogo1.svg';
import Logo1 from '../Image/Quickcashlogo15.svg';
 ...
 const Nav1 = ({history}) => {
    ...
    return (
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           {(nav)?
           <div className="logo img-fluid"><Link to ='/home'><img src={Logo} className="img-fluid logo-height"></img></Link></div>
            :
            <div className="logo img-fluid"><Link to ='/home'><img src={Logo1} className="img-fluid logo-height"></img></Link></div>
           }
           {/* <div className="logo img-fluid"><Link to =''><img src={Logo} className="img-fluid logo-height"></img></Link></div> */}
            <ul className="navLinks" ref= {navLinks}>
                
                {(nav)?
                <NavLink to="/home" exact  activeClassName='activlink' className="fir"><li>Home</li></NavLink>
                :
                <NavLink to="/home" exact  activeClassName='activlink' className="sec"><li>Home</li></NavLink>
                }

                {(nav)?
                  <NavLink to="/sellnow"activeClassName='activlink' className='fir'><li>Quick Sell / Quick BuyBack</li></NavLink>
                :
                <NavLink to="/sellnow"activeClassName='activlink' className="sec"><li>Quick Sell / Quick BuyBack</li></NavLink>       
                }

                {(nav)?
                <NavLink to="/shop" activeClassName='activlink' className='fir'><li>Quick Shop</li></NavLink>       
                :
                <NavLink to="/shop" activeClassName='activlink' className="sec"><li>Quick Shop</li></NavLink>                       
                }
              
                {(nav)?
                 <NavLink to="/maintenance" activeClassName='activlink' className='fir'><li>Auction</li></NavLink>        
                :
                <NavLink to="/maintenance" activeClassName='activlink' className="sec"><li>Auction</li></NavLink>                        
                }
        ...
        <div className = "rightComp" ref = {rightItems} style={{visibility:"hidden"}}>
