...
import Logo from '../Image/Quickcashlogo13.svg';
       ...
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           <div className="logo img-fluid"><Link to =''><img src={Logo} className="img-fluid logo-height"></img></Link></div>
            <ul className="navLinks" ref= {navLinks}>
                <NavLink to="/home" exact  activeClassName='activlink' ><li>Home</li></NavLink>
                <NavLink to="/sellnow"activeClassName='activlink' ><li>Quick Sell / Quick BuyBack</li></NavLink>
                <NavLink to="/shop" activeClassName='activlink' ><li>Quick Shop</li></NavLink>               
                <NavLink to="/maintenance" activeClassName='activlink'><li>Auction</li></NavLink>  
            </ul>
