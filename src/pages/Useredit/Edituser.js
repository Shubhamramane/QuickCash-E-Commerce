...
const Edituser = ({match,history}) => {
    ...
    }, [dispatch,userId1,history,user,successUpdate])

    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(updateUser({_id: userId1,name,email,isAdmin}))
    }
          ...
          <Nav/>
               ...
               {loading || loadingUpdate ? 
                        <div className='loading'>
                            <FadeLoader   color={"#1F34E9"}  loading={loading || loadingUpdate} size={40} />
                        </div>
